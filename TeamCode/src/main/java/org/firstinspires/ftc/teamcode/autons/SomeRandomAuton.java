...
//@Disabled
@Autonomous(name = "SomeRandomAuton", group = "Auton")
// @Autonomous(...) is the other common choice

public class SomeRandomAuton extends OpMode {
    ...
    public void loop() {
        ...
        switch (currentStage) {
            case _unknown:
                ...
                break;
            case _00_preStart:
                currentStage = stage._10_Drive_Forward;
                break;
            case _10_Drive_Forward:
                robot.driveTrain.cmdTurn(45, 0.35);
                currentStage = stage._20_Spin_Test1;
                break;
            case _20_Spin_Test1:
                if (robot.driveTrain.getCmdComplete()) {
                    robot.driveTrain.cmdTurn(179, 0.35);
                    currentStage = stage._30_PeanutButter;

                }
                break;
            case _30_PeanutButter:
                if (robot.driveTrain.getCmdComplete()) {
                    robot.driveTrain.cmdTurn(350,0.35);
                    currentStage = stage._40_ty;
                }
                break;
           case _40_ty:
                if (robot.driveTrain.getCmdComplete()) {
